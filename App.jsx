...
function App() {
  ...
  // Function to save history as an Excel file
  const handleSaveHistory = () => {
    ...
    // Prepare data for Excel
    const excelData = history.map((entry, idx) => ({
      'Entry #': idx + 1,
      'Timestamp': new Date(entry.timestamp).toLocaleString(),
      'Part Number': entry.formData.partNumber || '',
      'Part Name': entry.formData.partName || '',
      'Material': entry.formData.materialGrade || '',
      'Drill Size (in)': entry.formData.drillSize || '',
      'Length (in)': entry.formData.lengthToDrill || '',
      'RPM': entry.formData.rpm || '',
      'Feed Rate (in/min)': entry.formData.feedRate || '',
      'Features': entry.formData.numberOfFeatures || '',
      'Total Time (min)': entry.totalStandardTime || '',
      'Cutting Time (min)': entry.totalCuttingTime || '',
      'Setup Time (min)': entry.totalSetupTime || '',
      'Grinding Time (min)': entry.totalGrindingTime || '',
      'Inspection Time (min)': entry.totalInspectionTime || ''
    }));
    ...
    // Save the file
    XLSX.writeFile(wb, 'calculation_history.xlsx');
  };
                          ...
                          <CardContent className="space-y-4">
                            <div className="space-y-3">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="font-semibold text-red-600">{results.totalCuttingTime} min</span>
                              </div>
                              <div className="flex justify-between">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="font-semibold text-red-600">{results.totalSetupTime} min</span>
                              </div>
                              <div className="flex justify-between">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="font-semibold text-red-600">{results.totalGrindingTime} min</span>
                              </div>
                              <div className="flex justify-between">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="font-semibold text-red-600">{results.totalInspectionTime} min</span>
                              </div>
                              ...
                              <div className="flex justify-between text-lg font-bold">
                                ...
                                <span className="text-red-600">{results.totalStandardTime} min</span>
                              </div>
                            </div>
                          </CardContent>
                        </Card>
